...
//            logger.info("Request:"+p2.
    ...
    private PostMethod setUpGetUserToken(PostMethod p,String userTokenId) throws IOException {
        ...
        WebResource resource = tokenServiceClient.resource(tokenServiceUri).path("/usertoken/" + applicationtokenid + "/getusertokenbyusertokenid");
    ...
    public String getUserTokenByUserTicket(String userticket) {
        ...
        WebResource userTokenResource = tokenServiceClient.resource(tokenServiceUri).path("usertoken/" + myAppTokenId + "/getusertokenbyuserticket");
        MultivaluedMap<String,String> formData = new MultivaluedMapImpl();
